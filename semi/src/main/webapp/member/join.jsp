...
이 약관은 Asure 호텔앤리조트㈜(이하, “회사”)가 운영하는 온라인 인터넷 사이트 및 애플리케이션(이하, “홈페이지”)에서 제공하는
...
Asure 호텔앤리조트㈜는 온라인 회원 가입과 관련하여 아래와 같은 개인정보를 수집 및 이용하고 있습니다 .
...
Asure 호텔앤리조트㈜는 개인위치정보를 이용하여 서비스를 제공하고자 하는 경우에는 회원이 본 약관에 동의하면 위치정보 이용에 동의한 것으로 간주됩니다.
...
Asure 호텔앤리조트㈜의 온라인 회원 서비스 관련 정보, 혜택, 신상품 안내, 이벤트 및 맞춤 서비스 정보 수신을 위해
