...
<footer>
        <div class="flex-container">
               ...
               <br>
               소개   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <a href="<%=request.getContextPath()%>/hotelIntroduce/hotelintro.jsp"  class="link">호텔소개</a>&nbsp;&nbsp;
                   |&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/hotelIntroduce/hotelinfo.jsp" class="link">호텔정보</a>&nbsp;&nbsp;
                   |&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/hotelIntroduce/floorguide.jsp" class="link">층별안내도</a>&nbsp;&nbsp;
                   |&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/sitemap/sitemap.jsp" class="link">사이트맵</a>
               </div>
